...
{
    /// <inheritdoc />
    public partial class VesaoInicial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesOrdemItem", x => new { x.OrderId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_SalesOrdemItem_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesOrdemItem_SalesOrder_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrdemItem_ProductId",
                table: "SalesOrdemItem",
                column: "ProductId");
